<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <link rel="stylesheet" href="/client/img/style.css">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="border rounded">
                                        <a href="/client/homepage/show">
                                            <img style="width: 100%;" src="/client/img/cake1.webp"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group quantity mb-5"
                                        ...
                                        <input type="text" style="width: 50px;"
                                            class=" form-control-sm text-center border-0" value="1">
                                        <div class="input-group-btn">
